...
const Hero = () => {
    return ( 
        <section className={`bg-darkGrey hero h-[] md:h-[] sm:mb-[900px]  py-[100px] mb-[1200px] md:mb-[700px] lg:mb-[600px]  `} id="home">
           <div className={`   mt-[60px] ${styles.flexCenter} flex-col gap-14`}>
                <div className="text">
                <div className={`py-[] ${styles.boxWidth}  ${styles.paddingX} ${styles.flexCenter} sm:pt-[] md:pt-[] md:pb-[100px] flex-col text-center`}>
                ...
                <div className="image ">
                    ...
                    <div className="">
                        <div className="rounded-[8px] border border-[5px] border-[#FEFEFE33] bg-[#FEFEFE33]">
                        <img src={house1} className="" alt="" />
                        </div>
                        <img src={house2} className="rounded-[8px] border border-[5px] border-[#FEFEFE33] bg-[#FEFEFE33]" alt="" />
                    </div>
                    <div>
                        <img src={house3} className="rounded-[8px] border border-[5px] border-[#FEFEFE33] bg-[#FEFEFE33]" alt="" />
                    </div>
                    </div>
                </div>
           </div>
